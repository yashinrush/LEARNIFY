  ...
  return (
    <>
      <aside className="sticky top-0 hidden w-96 flex-col gap-6 self-start sm:flex">
        <article className="my-6 flex justify-between gap-4 bg-slate-600">
          <div
            className="relative flex cursor-default items-center gap-2 rounded-xl p-3 font-bold uppercase text-gray-500 hover:bg-gray-900"
          ...
          >
            ...
            >
              ...
              <button className="flex w-full items-center gap-3 border-t-2 border-gray-900 bg-blue-100 px-5 py-3 text-left font-bold">
                <Flag language={language} width={45} />
                <span className="text-blue-500">{language.name}</span>
              </button>
              <Link
                className="flex w-full items-center gap-3 rounded-b-2xl border-t-2 border-gray-900 px-5 py-3 text-left font-bold hover:bg-gray-100"
                href="/register"
              >
          ...
          <span
            ...
            tabIndex={0}
          >
            <div className="pointer-events-none hover:bg-gray-900">
            ...
            <div
              className="absolute top-full z-10 flex flex-col gap-5 rounded-2xl border-2 border-gray-300 bg-white p-5 text-black hover:bg-gray-900"
              style={{
                left: "calc(50% - 200px)",
                width: 400,
            ...
            >
              <h2 className="text-center text-lg font-bold hover:text-white">Streak</h2>
...
const LeaderboardRankSection = () => {
  ...
  const leaderboardLeague = "Level Three";
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 text-gray-700">
      ...
      <div className="flex gap-6">
        ...
        <div className="flex flex-col gap-5">
          ...
          <p className="text-sm leading-6 text-gray-500">
            You earned {xpThisWeek} points this week so far
          </p>
        </div>
      </div>
    </article>
...
const DailyQuestsSection = () => {
  ...
  return (
    <article className="flex flex-col gap-5 rounded-2xl border-2 border-gray-200 p-6 font-bold text-gray-700">
      <h2 className="text-xl">My Daily Goal</h2>
