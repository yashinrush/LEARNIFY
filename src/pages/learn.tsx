...
const HoverLabel = ({
  ...
  return (
    <div
      className={`absolute z-10 w-max animate-bounce rounded-lg border-2 border-gray-800 bg-whte px-3 py-2 font-bold uppercase ${textColor}`}
      style={{
        top: "-25%",
    ...
    >
      {text}
      <div
        className="absolute h-3 w-3 rotate-45 border-b-2 border-r-2 border-gray-200 bg-gray-800"
