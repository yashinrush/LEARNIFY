...
const Register: NextPage = () => {
  const setLanguage = useBoundStore((x:any) => x.setLanguage);
  return (
    <main
      className="flex min-h-screen flex-col items-center bg-[#2c2c2c] text-white"
  ...
  {languages.map((language) => (
    <Link
      ...
      href="/learn"
      className={
        "flex cursor-pointer flex-col items-center gap-4 rounded-2xl border-2 border-b-4 border-blue-400 px-5 py-8 text-xl font-bold hover:bg-gray-300 hover:bg-opacity-20"
      }
